...
def get(**kwargs):
    ...
    where = kwargs.get("where",{"status":1})
    ...
    if not hasattr(Product, tmp_order_by[0].lower()):
    ...
    print Product()
    print getattr(Product,tmp_order_by[0])
    print getattr(getattr(Product,tmp_order_by[0]), tmp_order_by[1])()
