...
Revision ID: e14c258c53f0
Revises: dfda9c3766fe
Create Date: 2016-05-29 06:58:26.228861

"""

# revision identifiers, used by Alembic.
revision = 'e14c258c53f0'
down_revision = 'dfda9c3766fe'
...
def upgrade():
    ...
    op.alter_column(u'idc', 'status',
               existing_type=mysql.INTEGER(display_width=11),
               nullable=False)
    op.drop_index('ix_idc_status', table_name='idc')
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.create_index('ix_idc_status', 'idc', ['status'], unique=False)
    op.alter_column(u'idc', 'status',
               existing_type=mysql.INTEGER(display_width=11),
               nullable=True)
